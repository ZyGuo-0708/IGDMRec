...
"""
Build Behavior Item-Item Graph
# Update: 2026/02/05
"""
import numpy as np
...
if __name__ == 	'__main__':
    ...
    train_data = train_df[[uid_field, iid_field]].values
    # item_item_pairs =[]
    ...
    for i in range(num_item):
        if item_num[i] <= top_k:
            ...
            edge_list = [edge_list_i, edge_list_j]
            item_graph_dict[i] = edge_list
    name = 'item_graph_dict_' + str(top_k) + 'drop3_wo_PageRank.npy'
